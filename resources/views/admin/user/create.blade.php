        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ URL::action('UserController@store') }}"
                            ...
                            <div id="form" class="form-group row">
                                <label for="first_name"
                                       class="col-md-2 col-form-label text-md-left">{{ __('First Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="last_name"
                                       class="col-md-2 col-form-label text-md-left">{{ __('Last Name') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="email"
                                       class="col-md-2 col-form-label text-md-left">{{ __('Email') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="date_of_birth"
                                       class="col-md-2 col-form-label text-md-left">{{ __('Birthday') }}</label>

                                <div class="col-md-10">
                                    <input id="date_of_birth" type="date"
                                           class="form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}"
                                           name="date_of_birth" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="avatar"
                                       class="col-md-2 col-form-label text-md-left">{{ __('Avatar') }}</label>
