    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ URL::action('userController@update') }}" aria-label="{{ __('Register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="date_of_birth" class="col-md-4 col-form-label text-md-left">{{ __('date_of_birth') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-left">{{ __('Avatar') }}</label>
                            ...
                            <img width="200px" height="200px" align="justify-content-center" src="{{Storage::url($getUserById['avatar'])}}">
