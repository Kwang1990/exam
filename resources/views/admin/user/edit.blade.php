        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ URL::action('UserController@update') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text"
                                           ...
                                           name="name" value="{{ old('name',$getUserById['name']) }}" required
                                           autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="first_name" type="text"
                                           ...
                                           name="first_name" value="{{ old('first_name',$getUserById['first_name']) }}"
                                           required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="last_name" type="text"
                                           ...
                                           name="last_name" value="{{ old('last_name',$getUserById['last_name']) }}"
                                           required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="email" type="email"
                                           ...
                                           name="email" value="{{ old('email',$getUserById['email']) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="date_of_birth" type="date"
                                           ...
                                           name="date_of_birth"
                                           value="{{ old('date_of_birth',$getUserById['date_of_birth']) }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="avatar" type="file"
                                           ...
                                           name="avatar" value="{{ old('path',$getUserById['avatar']) }}" required><br>
                                    <img class=".mx-auto d-block img-thumbnail" width="200px" height="200px"
                                         src="{{Storage::url($getUserById['avatar'])}}">
                                </div>
                            </div>
